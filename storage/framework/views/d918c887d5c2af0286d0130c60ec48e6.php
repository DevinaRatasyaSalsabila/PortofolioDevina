...
<!-- Mirrored from mixdesign.club/themeforest/braxton/index-svg.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Oct 2024 04:33:56 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('landing-page/img/favicon/favicon.ico')); ?>" sizes="any">
    <link rel="icon" href="<?php echo e(asset('landing-page/img/favicon/icon.svg')); ?>" type="image/svg+xml">
    <link rel="apple-touch-icon" href="<?php echo e(asset('landing-page/img/favicon/apple-touch-icon.png')); ?>">
    <link rel="manifest" href="<?php echo e(asset('landing-page/img/favicon/manifest.webmanifest')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('landing-page/css/loaders/loader.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-page/css/plugins.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('landing-page/css/main.css')); ?>">
    <!-- Template Styles End -->
...
<body>
    ...
    <header id="header" class="header d-flex justify-content-between">
        ...
        <div class="header__controls d-flex justify-content-end">
            ...
            <a id="notify-trigger" class="header__trigger btn" href="<?php echo e(route('login')); ?>">
        ...
        <div class="avatar__container d-flex flex-column justify-content-lg-between">
            ...
            <div class="avatar__block">
                ...
                <div class="avatar__image">
                    <img src="<?php echo e(asset('landing-page/img/avatars/1024x1024_a01.webp')); ?>"
                    ...
                    <ul class="socials-square d-flex justify-content-between">
                        ...
                        <li class="socials-square__item">
                            <a class="socials-square__link btn" href="https://www.twitch.tv/" target="_blank"><i
                                    class="ph-bold ph-twitch-logo"></i></a>
                        </li>
                        <li class="socials-square__item">
                                ...
                                <div class="col-12 col-sm-6 col-md-6 cards__item grid-item animate-card-2">
                                    <div class="cards__card d-flex flex-column">
                                        <div class="cards__image d-flex animate-in-up">
                                            <a href="<?php echo e(url('detailHalaman', $item->id)); ?>">
                                                <img src="<?php echo e(asset('storage/' . $item->gambar1)); ?>" alt="Service/Feature Image">
                                            </a>
                                        </div>
                ...
                <div class="content__block grid-block block-large">
                    <div class="tools-cards d-flex justify-content-start flex-wrap">
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/icon-photoshop.svg')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/icon-figma.svg')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/icon-html.svg')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/icon-css.svg')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/php.png')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/laravel.svg')); ?>" alt="Tools Icon">
                        ...
                        <div class="tools-cards__item d-flex grid-item-s animate-card-5">
                            <div class="tools-cards__card">
                                <img class="tools-cards__icon animate-in-up"
                                    src="<?php echo e(asset('landing-page/img/icons/bootstrap.png')); ?>" alt="Tools Icon">
    ...
    <script src="<?php echo e(asset('landing-page/js/libs.min.js')); ?>"></script>
    <script>
    ...
    <script src="<?php echo e(asset('landing-page/js/app.js')); ?>"></script>
    <script src="<?php echo e(asset('landing-page/js/gallery-init.js')); ?>"></script>

</body>

</html>
<?php /**PATH C:\laragon\www\portofolio_devina\resources\views\index.blade.php ENDPATH**/ ?>