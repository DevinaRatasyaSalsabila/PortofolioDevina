    ...
    <head>
        ...
        <!-- Stylesheets -->
        <link rel="stylesheet" href="<?php echo e(asset('detail/assets/css/bootstrap.min.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('detail/assets/css/fontawesome.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('detail/assets/css/slick.css')); ?>" />
        <link rel="stylesheet" href="<?php echo e(asset('detail/assets/css/lightgallery.min.css')); ?>" />
    ...
    <body id="home" style="font-family: 'Syne', sans-serif;">
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-md-1">
                            <div class="st-post-details st-style1" id="beranda">
                                <h2><?php echo e($portofolio->judul); ?></h2>
                                <p><?php echo e($portofolio->deskripsi); ?></p>
                                <img class="st-zoom-in" src="<?php echo e(asset('storage/' . $portofolio->gambar1)); ?>"
                                    alt="blog1">
                                <h2>Teknologi Yang Diguankan</h2>
                                <div class="st-post-info">
                                    <div class="st-post-text">
                                        <p>
                                            <?php echo e($portofolio->judul); ?> dibangun dengan <?php echo e($portofolio->label); ?>.Kami
                                            memilih
                                            teknologi ini agar<?php echo e($portofolio->judul); ?> tampil responsif, modern, dan
                                        ...
                                        <p>
                                            Klik tombol di bawah ini untuk melihat demo <?php echo e($portofolio->judul); ?> kami!
                                            Dalam demo ini,
        ...
        <?php endif; ?>
        <!-- Scripts -->
        <script src="<?php echo e(asset('detail/}assets/js/jquery-1.12.4.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/jquery.slick.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/lightgallery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/wow.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/ripples.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/particles.min.js')); ?>"></script>
        <script src="<?php echo e(asset('detail/assets/js/main.js')); ?>"></script>
    </body>
...
<?php /**PATH C:\laragon\www\portofolio_devina\resources\views\detailHalaman.blade.php ENDPATH**/ ?>