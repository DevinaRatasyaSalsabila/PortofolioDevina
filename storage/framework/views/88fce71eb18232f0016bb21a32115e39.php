...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <form action="<?php echo e(route('admin')); ?>">
        ...
        <div class="sidenav-footer mx-3 ">
            ...
            <a class="btn btn-primary mt-3 w-100"><?php echo e(Auth::user()->name); ?> <br>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $portofolio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        min-width: 300px;
                                                        max-width: 600px">
                                                            <?php echo e(Str::limit($item->deskripsi), 100); ?> <br>
                                                        </td>
                                                        <td class="text-dark text-center"
                                                            style="white-space: normal;
                                                        ...
                                                        max-width: 600px">
                                                            <a class="link-primary"
                                                                href="<?php echo e($item->link); ?>"><?php echo e($item->link); ?>
                                                            ...
                                                            <div class="btn-group" role="group">
                                                                <form>
                                                                    <button type="button"
                                                                        ...
                                                                        data-bs-target="#modalUbah<?php echo e($item->id); ?>">
                                                                        Ubah
                                                                    </button>
                                                                </form>
                                                                ...
                                                                <form action="<?php echo e(url('detailHalaman', $item->id)); ?>"
                                                                    method="get">
                                                                    <a href="<?php echo e(url('detailHalaman', $item->id)); ?>" class="btn btn-primary btn-sm m-1">
                                                                        Detail
                                                                    </a>
                                                                </form>
                                                            </div>
    ...
    <?php $__currentLoopData = $portofolio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form action="/ubah/<?php echo e($item->id); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="deskripsi" class="col-form-label">Deskripsi</label>
                                <textarea id="deskripsi" class="form-control" rows="5" name="deskripsi" required><?php echo e($item->deskripsi); ?> </textarea>
                            </div>
                            <div class="mb-3">
                                <label for="tanggal" class="col-form-label">Tanggal</label>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="<?php echo e(asset('storage/' . $item->gambar1)); ?>" class="my-1" alt="Gambar 1"
                                    style="max-width: 100px; max-height: 100px;">
...
<?php /**PATH C:\laragon\www\portofolio_devina\resources\views\admin.blade.php ENDPATH**/ ?>