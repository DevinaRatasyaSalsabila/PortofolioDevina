    ...
    <section class="vh-100" style="background-color: #343d3c;">
        <div class="container h-100">
          <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-6">
                <form action="{{ route('registrasiSubmit') }}" method="POST">
                    @csrf
                        <div class="card shadow-lg p-3 mb-3 bg-body-tertiary rounded">
                            <img src="{{ asset('add-friend.png') }}" width="30%" class="mx-auto d-block"
                            alt="">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center my-2">Sudah punya akun?<a href="{{ route('login') }}">Login Disini</a></p>
                            </div>
                        </div>
                    </div>
                </form>
